...
def load_and_preprocess_data(train_file, test_file, seq_length=150):
    """
...
def build_gru_model(input_shape, num_classes):
    ...
    """
    model = Sequential([
        GRU(128, return_sequences=True, kernel_regularizer=l2(0.002), input_shape=input_shape),
        Dropout(0.5),
        GRU(64, return_sequences=True, kernel_regularizer=l2(0.002)),
        Dropout(0.5),
