...
def load_model_and_encoders(model_path="output/best_gesture_gru.keras", 
                            label_encoder_path="output/gesture_label_encoder.npy", 
                            scaler_path="output/gesture_scaler.npy"):
    """
    Load the trained GRU model, label encoder, and scaler.
    """
...
if __name__ == "__main__":
    test_file = "../Gestures/Test/clap/received_data_20250131_162858.csv"  # Example test file
